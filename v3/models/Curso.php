...
// CursoModel
//
// Cursos disponibilizados na institui��o.
//
// Gerado em: 2018-03-16 07:24:07
// --------------------------------------------------------------------------------
class CursoModel extends BDConBaseModel
{
    // Construtor da classe, executado quando a classe � criada
    function __construct() {
        parent::__construct();
        $this->IdCurso = md5(uniqid(rand(), true));
    }
    ...
    protected $IdCurso;                                                    // char(32), PK, obrigat�rio - Identificador do Curso
    ...
    {
        if (isset($this->IdCurso) && isset($this->IdInstituicao)) {
            $sql = "delete from 
                        curso
                     where 
                        idcurso" . ( isset($this->IdCurso) ? " = " . $this->o_db->quote($this->IdCurso) : " is null" ) . "
        ...
        string $Status = null)
    {
        ...
        if ($resultset = $this->o_db->query($sql)) {
            ...
            while ($obj_in = $resultset->fetchObject()) {
                ...
                array_push($array_curso, $obj_out);
            }
        }
    ...
    public function listByIdInstituicaoNome(
        ...
        string $Nome = null)
    {
        return $this->listBy($pagenumber, $pagesize, null, $IdInstituicao, $Nome, null, null);
    }
    ...
    public function listByIdInstituicaoSigla(
        ...
        string $Sigla = null)
    {
        return $this->listBy($pagenumber, $pagesize, null, $IdInstituicao, null, $Sigla, null);
    }
    ...
    // --------------------------------------------------------------------------------
    public function loadById( string $IdCurso, string $IdInstituicao )
    {
        $obj = $this->objectByFields($IdCurso, $IdInstituicao, null, null, null);
        if ($obj) {
    ...
    {
        $obj = $this->objectByFields(null, $this->IdInstituicao, $this->Nome, null, null);
        return !($obj && ($obj->IdCurso === $this->IdCurso) && ($obj->IdInstituicao === $this->IdInstituicao));
    }
    ...
    {
        $obj = $this->objectByFields(null, $this->IdInstituicao, null, $this->Sigla, null);
        return !($obj && ($obj->IdCurso === $this->IdCurso) && ($obj->IdInstituicao === $this->IdInstituicao));
    }
    ...
    public function countByIdInstituicaoNome(
        ...
        string $Nome = null)
    {
        return $this->countBy(null, $IdInstituicao, $Nome, null, null);
    }
    ...
    public function countByIdInstituicaoSigla(
        ...
        string $Sigla = null)
    {
        return $this->countBy(null, $IdInstituicao, null, $Sigla, null);
    }
