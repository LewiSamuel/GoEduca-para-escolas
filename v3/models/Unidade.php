...
// UnidadeModel
//
// Unidades das Institui��es que contratam o servi�o de aux�lio a educa��o via jogos.
//
// Gerado em: 2018-03-16 07:25:39
// --------------------------------------------------------------------------------
class UnidadeModel extends BDConBaseModel
{
    ...
    protected $IdUnidade;                                                  // char(32), PK, obrigat�rio - Identificador da Unidade
    protected $Nome;                                                       // varchar(256), obrigat�rio - Nome da Unidade
    protected $RazaoSocial;                                                // varchar(256), obrigat�rio - Raz�o Social da Unidade
    protected $Cnpj;                                                       // varchar(32), obrigat�rio - CNPJ da Unidade
    protected $InscEstadual;                                               // varchar(32), opcional - Inscri��o Estadual da Unidade
